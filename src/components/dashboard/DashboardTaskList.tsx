      ...
      {tasks.map((task) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={cn(
                "w-1.5 h-8 rounded-full flex-shrink-0 opacity-90 group-hover:opacity-100 transition-opacity",
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-extrabold text-[#0A1237] dark:text-white truncate group-hover:text-primary transition-colors tracking-tight">
                {task.title}
              </p>
              <div className="flex items-center gap-2 mt-0.5">
                <p className="text-xs font-semibold text-text-muted truncate flex items-center gap-1.5">
                  <span className="inline-flex items-center justify-center h-4 w-4 rounded bg-[#0A1237] text-[#C3D946] text-[8px]">
                ...
                {task.assignee && (
                  <>
                    ...
                    <div className="flex items-center gap-1">
                      <div className="h-4 w-4 rounded-full overflow-hidden bg-[#0A1237] text-[#C3D946] text-[8px] flex items-center justify-center font-black">
            ...
            {task.dueDate && (
              <span
                className={cn(
                  "flex items-center gap-1.5 text-[11px] font-extrabold px-2.5 py-1 rounded-full border",
                  overdue
