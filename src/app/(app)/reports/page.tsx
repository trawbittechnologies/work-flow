  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex items-center justify-between">
        ...
        <button className="inline-flex items-center gap-2 h-9 px-4 text-xs font-bold rounded-xl bg-white border border-[#E5E7EB] text-[#374151] hover:bg-[#F9FAFB] transition-colors shadow-2xs">
          <Download className="h-4 w-4 text-[#6B7280]" /> Export CSV
        </button>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div className="bg-white border border-[#EAEDF2] rounded-2xl p-5 shadow-2xs">
          <p className="text-xs font-semibold text-[#6B7280]">Velocity Rate</p>
          <h3 className="text-2xl font-black text-[#111827] mt-1">94.2%</h3>
        ...
        <div className="bg-white border border-[#EAEDF2] rounded-2xl p-5 shadow-2xs">
          ...
          <h3 className="text-2xl font-black text-[#111827] mt-1">2.4 days</h3>
          <p className="text-xs font-semibold text-[#16A34A] mt-1 flex items-center gap-1">
        ...
        <div className="bg-white border border-[#EAEDF2] rounded-2xl p-5 shadow-2xs">
          ...
          <h3 className="text-2xl font-black text-[#111827] mt-1">Jishnu TV</h3>
